...
export default function ChallengeCard({
  ...
  return (
    <div
      onClick={onClick}
      className="group relative cursor-pointer overflow-hidden rounded-lg border border-[#00E1FF]/60 bg-transparent p-6 backdrop-blur-md transition-all duration-300 hover:-translate-y-1 hover:border-[#00E1FF] hover:shadow-[0_0_20px_rgba(0,225,255,0.3)]"
    >
