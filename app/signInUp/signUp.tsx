    ...
    <div className="relative flex min-h-screen flex-col items-start justify-center bg-black px-32 py-8">
      ...
      <form className="ml-23 flex w-fit flex-col gap-4" method="POST">
        <input
          ...
          name="userName"
          placeholder="Name"
          className="rounded-lg border-2 border-gray-600 bg-transparent px-4 py-2 text-white placeholder-gray-400 transition-all duration-300 focus:border-[#00E1FF] focus:outline-none"
